...
Revision ID: 9429a0f56cbf
Revises: 
Create Date: 2025-12-03 23:19:58.231250
...
def upgrade() -> None:
    ...
    op.create_index('ix_asset_asset_type', 'assets', ['asset_type'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_asset_asset_type', table_name='assets')
