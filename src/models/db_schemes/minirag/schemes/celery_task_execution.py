...
class CeleryTaskExecution(SQLAlchemyBase):
    ...
    task_args_hash = Column(String(64), nullable=False) #SHA-256 hash of the task arguments for idempotency
    ...
    result = Column(JSONB, nullable=True) # Store the result or error message
